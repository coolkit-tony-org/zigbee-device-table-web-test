...
export const sortByDeviceInfoGroup = (rows: FlatRow[]): FlatRow[] =>
    rows.slice().sort((a, b) => {
        ...
        const typeCmp = compareString(a.deviceType, b.deviceType);
        ...
        const supportedCmp = compareBoolean(a.ewelinkSupported, b.ewelinkSupported);
        if (supportedCmp !== 0) return supportedCmp;
...
const isSameDeviceInfoGroup = (a: FlatRow, b: FlatRow): boolean => {
    ...
    if (a.ewelinkSupported !== b.ewelinkSupported) return false;
